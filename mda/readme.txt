    ...
    The project located in this directory has been generated by Onalenna Junior Makhura
    ...
    that a model called 'molemi' has been created within your Magic Draw model.
    ...
    having Maven downloading any SNAPSHOT dependencies.
        ...
        %> mvn -f web/pom.xml -Ddeploy
            ...
            collects all artifacts and builds a deployable .jar which is then
            deployed
        ...
        %> mvn -f web/pom.xml andromdapp:undeploy -o
            ...
            undeploys the jar from your app server
    ...
    this might be a directory looking like this:
        ...
        (*nix)
        /home/Onalenna Junior Makhura/.m2/repository/molemi/
